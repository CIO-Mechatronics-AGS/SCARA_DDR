...
l1 = 0.2;   %---> h desfase de altura con respecto al suelo
l2 = 1;   %---> L1 longitud del primer eslabón
l3 = 1;   %---> L2 longitud del segundo eslabón
d3_max = 0.2; %---> longitud del tercer eslabón
d = (80/4)/100; %---> metros que se mueve por cada 360°

control_th1 = control_SCARA(0.000022);
control_th2 = control_SCARA(0.0000046);
control_th3 = control_SCARA(0.000011);
